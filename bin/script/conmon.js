...
export const SnLoadingState = (state, className, idName = null) => {
    let actions = document.querySelectorAll(`.${className}`);
    let submitBtn = document.getElementById(idName);
    if (state) {
        if (submitBtn) {
